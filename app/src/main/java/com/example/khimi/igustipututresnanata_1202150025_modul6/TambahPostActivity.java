                    ...
                    image.putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> uploadTask) {
                            ...
                            if (uploadTask.isSuccessful()) {
                                ...
                                Toast.makeText(TambahPostActivity.this, "Error : " + uploadTask.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });

                    //displaying a success toast
                    Toast.makeText(TambahPostActivity.this, "Uploaded", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(TambahPostActivity.this, MainActivity.class);
                    startActivity(i);
                } else {
                    //if the value is not given displaying a toast
                    Toast.makeText(TambahPostActivity.this, "Please Fill the form and choose image", Toast.LENGTH_LONG).show();
                }
            }
